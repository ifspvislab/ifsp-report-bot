...
from reportlab.platypus import SimpleDocTemplate, Paragraph, Spacer, Table, Image, Spacer
...
doc = SimpleDocTemplate("relatorio_teste.pdf", pagesize=A4,
                        leftMargin=1.18 * inch, rightMargin=0.79 * inch,
                        topMargin=0.79 * inch, bottomMargin=0.79 * inch)
...
information_paragraph = Paragraph("INSTITUTO FEDERAL DE EDUCAÇÃO, CIÊNCIA E TECNOLOGIA DE SÃO PAULO", 
name_of_institution_text_style)

public_notice_paragraph = Paragraph("EDITAL Nº SPO.009, DE 1º DE FEVEREIRO DE 2023", public_notice_text_style)

annex_paragraph = Paragraph("ANEXO V - RELATÓRIO SEMESTRAL DE FREQUÊNCIA E AVALIAÇÃO - 2023", annex_text_style)

activities_paragraph1 = Paragraph("Resumo das atividades desenvolvidas no ____ semestre / 2023", activities_text_style)
activities_paragraph2 = Paragraph("Este relatório inclui as atividades desenvolvidas no mês de ___________ / 2023 e o relatório de desempenho do(a) voluntário(a)", activities_text_style)

observation_paragraph = Paragraph("Observação: Entregar este relatório via plataforma Moodle até o último dia 05 do semestre letivo vigente, conforme previsto no Edital.", observation_text_style)

signatures_paragraph = Paragraph("________________________________&nbsp;&nbsp;&nbsp;&nbsp;________________________________", signatures_text_style)

participants_paragraph1 = Paragraph("Voluntário(a)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Professor(a) Responsável", participants_text_style)
