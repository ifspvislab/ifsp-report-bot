...
This module provides the MonthlyReportService class for managing interactions with 
the monthly report.

Classes:
- MonthlyReportService: Service class for managing monthly report data.
...
- verifiy_member_validity: Checks if the student can request the monthly report.
- generate_monthly_report: Creates the monthly report in bytes format.
"""
...
class MonthlyReportService:
    """
    Service class for managing monthly report data.

    This class provides methods for generating monthly reports, verifying member validity,
    ...
    def __init__(
        ...
        """
        Initializes the MonthlyReportService class.
    ...
    def verifiy_member_validity(
        ...
        """
        Checks if the student can request the monthly report.
    ...
    def generate_monthly_report(
        ...
        """
        Generates the monthly report in bytes format.
    ...
    def generate_report_info(self, student_name):
        ...
        Example:
            ("RELATORIOMENSAL_ENSINO_MONTH_STUDENTNAME.PDF",
            "Sucesso, Student! Aqui está o relatório mensal em formato PDF:")

        """
        month = datetime.now().strftime("%B")
        name_of_report = (f"RelatorioMensal_Ensino_{month}").upper()
        name_of_report += (f"_{student_name}").upper() + ".pdf"
        student_first_name = student_name.split()[0]
        content = f"Sucesso, {student_first_name}! Aqui está o relatório mensal em formato PDF:"
