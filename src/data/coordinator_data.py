...
class CoordinatorData:
    ...
    """
    Convert a row of data from the coordinators.csv file into a dictionary.
    ...
    """
            ...
            with open(
                "assets/data/coordinators.csv", "a", encoding="UTF-8"
                    ...
                    coordinator_data.write(f"{coordinator.prontuario}, {coordinator.discord_id}, {coordinator.nome}, {coordinator.email}\n")