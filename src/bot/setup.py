...
import settings
from services import ProjectService, StudentService, CoordinatorService

from .cogs import ProjectCog
...
def start_bot(
    ...
    async def on_ready():
        ...
        await bot.add_cog(ProjectCog(project_service, coordinator_service))
        await bot.tree.sync()
